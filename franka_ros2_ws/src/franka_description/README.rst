.. note::
   ...
   Modified distribution: this project includes only FR3 and the white Franka Hand.
   Other robot models, accessories and upstream CI/Docker files are omitted.
   The upstream instructions below may refer to those omitted features.
